    ...
    return (<>
        <div className="privacy-container">
            ...
            <ul>
                ...
                <li>
                    <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Wrench Mate,
                    Plot no B5, Janaki Nagar, Langer House, Hyderabad-500008.
                </li>
                <li>
                ...
                <li>
                    <strong>Website</strong> refers to Wrench Mate, accessible from <a href="https://wrenchmate.in">wrenchmate.in</a>
                </li>
                <li>
            ...
            <p>
                ...
                used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We use may include:
            </p>
            <ul>
                <li>
                ...
                <li>
                    ...
                    (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited
                    those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying
            ...
            <p>
                ...
                Session Cookies are deleted as soon as You close Your web browser. We use both Session and Persistent Cookies for the purposes set out below:
            </p>
            <ul>
                <li>
            ...
            <ul>
                ...
                <strong>To provide You</strong> with news, special offers and general information about other goods, services and events which we offer that are similar
            ...
            <p>
                ...
                a parent or guardian and You are aware that Your child has provided Us with Personal Data, please contact Us. If We become aware that We have collected Personal Data
            ...
            <ul>
                <li>By email: <a href="mailto:ptejeshreddy22@gmail.co">ptejeshreddy22@gmail.co</a></li>
            </ul>
        </div>
        </>
    );
